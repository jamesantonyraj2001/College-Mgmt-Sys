...
from .models import Student, Class, Attendance, Notification
from .forms import AttendanceForm

from django.views.generic.edit import FormView
from django.urls import reverse_lazy
from .models import Attendance
from .forms import AttendanceForm, NotificationForm
...
def student_add_view(request):
    ...
    return render(
        ...
        {"title": "Add Student | CMS", "form": form},
    )
...
def take_attendance(request):
    if request.method == 'POST':
        ...
        Attendance.objects.create(student=student, subject=subject, department=department, date=date, is_present=is_present, time=time)
...
class AttendanceView(FormView):
    template_name = 'attendance_form.html'  # Create an HTML template for the form
    form_class = AttendanceForm
    success_url = reverse_lazy('success_url_name')  # Replace with the actual URL
    ...
    def form_valid(self, form):
        ...
        attendance, created = Attendance.objects.get_or_create(
            student=student, subject=subject, date=date, time=time,department=department,
...
def notification(request):
    if request.method == 'POST':
        ...
        Notification.objects.create(student=student,content=content )
        messages.success(request, "Notification Sent Successfully.")
    else:
        form = NotificationForm()
    
    return render(request, 'attendance/notification.html', {'form': form})

def view_notification(request):
    # Retrieve and display attendance records
    notification_records = Notification.objects.all()
    return render(request, 'attendance/view_notification.html', {'notification_records': notification_records})


class NotificationView(FormView):
    template_name = 'notification_form.html'  # Create an HTML template for the form
