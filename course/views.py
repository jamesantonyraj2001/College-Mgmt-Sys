...
class CourseAllocationFormView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = "Assign Course | CMS"
        return context
...
def course_registration(request):
    if request.method == 'POST':
        ...
        for i in courses:
            ...
            if i.semester == "Third":
                total_third_semester_credit += int(i.credit)
        ...
        context = {
            ...
            "total_third_semester_credit": total_third_semester_credit,
